...
public class LtuSeEduBliStudentPage {
    public SelenideElement datorITlänk = $(
            "html > body > main > div > div > div > div:nth-of-type(1) > nav > div > ul > li:nth-of-type(1) > ul > li:nth-of-type(4)");

    public SelenideElement Systemvetenskap = $(
            "html > body > main > div > div > div > div:nth-of-type(1) > nav > div > ul > li:nth-of-type(7)");
